...
import {
  updateStart, updateSuccess, updateFailure, deleteUserFailure, deleteUserSuccess, deleteUserStart,
  signoutSuccess
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input type="file" accept='image/*' onChange={handleImageChange} ref={filePickerRef} hidden id='' />
